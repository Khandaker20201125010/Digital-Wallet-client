  ...
  return (
    <div className="container mx-auto flex w-full flex-col items-center justify-between gap-12 px-6 py-16 text-black lg:flex-row dark:text-white">
      ...
      >
        ...
        <div className="relative mx-auto w-full max-w-[600px] rounded-2xl border border-purple-700 bg-white/5 p-4 pb-14 max-sm:max-w-[320px] sm:p-5 md:p-6 lg:p-6">
          {/* Sender */}
          <div className="mb-4 flex items-center justify-between gap-3">
            ...
            <div className="ml-2 flex-shrink-0">
              <img
                ...
                alt="USA"
                className="h-10 w-10 rounded-full border object-cover sm:h-12 sm:w-12 md:mx-40"
              />
            </div>
          </div>
          ...
          <div className="relative mb-6 flex items-center justify-center md:justify-center lg:justify-start">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-xl text-white shadow-lg sm:h-12 sm:w-12 sm:text-2xl md:mx-62">
              <FaTelegramPlane />
            </div>
            ...
            <div
              className={
                ...
                'lg:static lg:-bottom-5 lg:left-96 lg:ml-4 lg:w-3/6 lg:translate-x-0 lg:justify-start'
              }
            >
          ...
          <div className="mt-8 flex items-center justify-between gap-3">
            ...
            <div className="ml-2 flex-shrink-0">
              <img
                ...
                alt="Australia"
                className="h-10 w-10 rounded-full border object-cover sm:h-12 sm:w-12 md:mx-44"
              />
            </div>
          </div>
        </div>
