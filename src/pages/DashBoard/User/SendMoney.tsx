    ...
    <div data-aos="zoom-in" data-aos-duration="1500" className="relative min-h-[80vh] flex items-center justify-center px-4 sm:px-6 lg:px-8">
      ...
      <Card className=" dark:border- -700 relative w-full max-w-md rounded-xl border border-red-200 bg-white shadow-2xl sm:max-w-lg dark:bg-gray-900">
        <CardContent className="space-y-6">
          <h2 className="text-2xl sm:text-3xl font-extrabold bg-gradient-to-r from-red-600 via-pink-500 to-purple-500 bg-clip-text text-transparent">Send Money</h2>

          <div className="space-y-2">
            <label className="block text-gray-700 dark:text-gray-300">Recipient (User Id)</label>
            <input
              type="text"
