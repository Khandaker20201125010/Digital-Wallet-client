                        ...
                        <motion.li key={item.label} className="relative">
                            ...
                            >
                                ...
                                >
                                    <Link
                                        to={item.path}
                                        className={`group flex items-center gap-2 px-4 py-2 text-gray-600 dark:text-gray-300 rounded-xl transition-colors ${item.iconColor}`}
                                    >
                                        <span>{item.icon}</span>
            ...
            >
                {navItems.map((item) => (
                    <Link
                        key={item.label}
                        to={item.path}
                        className="w-full text-center px-4 py-2 text-gray-600 dark:text-gray-300 rounded-xl"
                    >
                        {item.label}
                    </Link>
                ))}
